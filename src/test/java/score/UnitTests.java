...
public class UnitTests {
  ...
  String exampleSection1Json() {
    ...
    return new JSONObject()
        .put("name", templateName2)
        .toString();
  }
  
  String exampleSection2Json() {
    return new JSONObject()
        .put("name", sectionName2)
        .put("weight" , 1)
        .toString();
  }
    ...
    return new JSONObject()
        .put("name", templateName3)
        .toString();
  }
  
  String exampleSection3Json() {
    return new JSONObject()
        .put("name", sectionName3)
        .put("weight" , 1)
        .toString();
  }
  ...
  @Test
  void addTemplates() {
    String template1URI = given()
      .contentType(ContentType.JSON)
      .body(exampleTemplate1Json())
      .when()
      .post(templateUri)
      .then()
      .statusCode(201)
    ...
    String section1URI = given()
      .contentType(ContentType.JSON)
      .body(exampleSection1Json())
      .when()
      .post(apiBaseUri + URI.create(template1URI).getPath() + "/" + section)
      .then()
      .statusCode(201)
    ...
    given()
      .contentType(ContentType.JSON)
      .body(examplePossibleResponse1Json())
      .when()
      .post(section1PossibleAnswersURI)
      .then()
      .statusCode(201)
      .extract()
      .response()
    ...
    given()
      .contentType(ContentType.JSON)
      .body(examplePossibleResponse2Json())
      .when()
      .post(section1PossibleAnswersURI)
      .then()
      .statusCode(201)
    ...
    given()
      .contentType(ContentType.JSON)
      .body(examplePossibleResponse3Json())
      .when()
      .post(section1PossibleAnswersURI)
      .then()
      .statusCode(201)
